 ...
 * round-trips, MRTR request state, the authorization-server switch in the
 * SEP-2352 migration scenario) cannot be judged there; the matrix shows them
 * as not startable with this reason.
 */
